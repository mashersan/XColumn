...
5.  **設定メニュー**: 各カラムの歯車ボタン（⚙️）から、自動更新間隔やRT/Rep非表示の設定を行えます。
...
5.  **Column Settings**: Use the gear icon (⚙️) on each column to access auto-refresh intervals and display filters.
